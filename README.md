...
- [Agent Skills — Production-Grade Engineering Skills for AI Coding Agents (44.9K Stars)](https://github.com/addyosmani/agent-skills) ⭐44,906
- [GitNexus — Zero-Server Code Intelligence Engine for AI Agents (39.8K Stars)](https://github.com/abhigyanpatwari/GitNexus) ⭐39,781
- [CLI-Anything — Turn Any Desktop Software Into Agent-Native CLI (39.6K Stars)](https://github.com/HKUDS/CLI-Anything) ⭐39,636
...
- [rmux — Universal Rust Multiplexer for Driving CLI/TUI Apps from Code](https://github.com/Helvesec/rmux) ⭐572
...
- [Centaur — Self-Hosted Secure Agent Platform by Paradigm](https://github.com/paradigmxyz/centaur) ⭐398
...
- [CCGlass — See What Your Coding Agent Sends to the Model](https://github.com/jianshuo/ccglass) ⭐31
...
- [Microsoft Semantic Kernel RCE Chain — CVE-2026-26030/25592 (CVSS 9.9)](https://intel.threadlinqs.com/#TL-2026-0481)
- [vm2 CVE-2026-24120 — Sandbox Escape (CVSS 9.8) in Agent Code Execution](https://www.cve.org/CVERecord?id=CVE-2026-24120)
- [CVE-2026-7061 — ChatGPT-MCP-Server Docker Command Injection (CVSS 7.3)](https://github.com/Toowiredd/chatgpt-mcp-server/issues/8)
- [FlowiseAI 10 Critical Flaws (CVSS 9.9) — RCE Cascade via CSV/Airtable Agent Injection](https://github.com/FlowiseAI/Flowise/security/advisories)
- [MCP 2026-07-28 RC — Protocol Goes Stateless, No Session ID, No Handshake](https://x.com/dsp_/status/2057780712187580924)
- [Pydantic AI CVE-2026-46678 — SSRF Cloud-Metadata Bypass via IPv6 Transition Forms](https://dailycve.com/pydantic-ai-ssrf-cloud-metadata-blocklist-bypass-via-ipv6-transition-forms-cve-2026-46678-moderate/)
- [mcp-yoshi v1.4.0 — MCP Security Filter Covering 76% of Flowise 59 CVEs](https://x.com/aliksir_mirage/status/2049632472405520888)
- [Cline CVE-2026-44211 — WebSocket Origin Bypass Enables Agent Session Hijack and RCE (CVSS 9.3)](https://x.com/apartresearch)
- [Gemini CLI CVSS 10.0 — Malicious Repo Config Grants Full RCE in CI/CD](https://x.com/vitobotta)
...
- [moltis](https://github.com/moltis-org/moltis) ⭐2,698
- [OctoTools](https://github.com/octotools/octotools) ⭐1,462
- [OpenSquilla](https://github.com/opensquilla/opensquilla) ⭐1,278
- [smallcode](https://github.com/Doorman11991/smallcode) ⭐1,216
...
- [Lapdog (Datadog)](https://lapdog.datadoghq.com/)
...
- [TraceFix](https://ortiz.rutgers.edu/projects/tracefix/)
- [Warp Oz Multi-Agent Orchestration](https://x.com/warpdotdev/status/2056772856835453395)
- [Open Multi-Agent](https://github.com/open-multi-agent/open-multi-agent)
- [Sandcastle](https://github.com/mattpocock/sandcastle)

## 📦 Retrieval

- [Retrieval Routing: vector + GraphRAG + PageIndex](https://x.com/NullS0S/status/2056383310830735676)
